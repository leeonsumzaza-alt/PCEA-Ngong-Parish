...
function Leadership() {
  ...
  const elders = [
    ...
    { id: 2, name: "Jack Ndungu", role: "Parish Elder" },
    { id: 3, name: "Gerishon Gikonyo", role: "Parish Elder" },
    { id: 4, name: "Stephen Munyiri", role: "Parish Elder" },
    { id: 5, name: "Elizabeth Gathogo", role: "Parish Elder" },
    { id: 6, name: "Njung'e Ndugire", role: "Parish Elder" },
    { id: 7, name: "Paul Mburu", role: "Parish Elder" },
    { id: 8, name: "Mary Mugo", role: "Parish Elder" },
    { id: 9, name: "Alice Warugongo", role: "Parish Elder" },
    { id: 10, name: "Salaash Lewett", role: "Parish Elder" },
    { id: 11, name: "Florence Theuri", role: "Parish Elder" },
    { id: 12, name: "Edward Kagwe Giturwa", role: "Parish Elder" },
    { id: 13, name: "Antony Nganga", role: "Parish Elder" },
    { id: 14, name: "Virginia Macharia", role: "Parish Elder" },
    { id: 15, name: "Martin Tiampati", role: "Parish Elder" },
    { id: 16, name: "John Kiarie Mwihandi", role: "Parish Elder" },
    { id: 17, name: "Antony Nyamu Mahinge", role: "Parish Elder" },
    { id: 18, name: "Peter Kanyara", role: "Parish Elder" },
    { id: 19, name: "Roseline Gathage", role: "Parish Elder" },
  ...
  const retiredElders = [
    ...
    { id: 2, name: "Geoffrey Kaminja" },
    { id: 3, name: "Freshia Kungu" },
    { id: 4, name: "Hellen Maina" },
    { id: 5, name: "Hellen Kasuku" },
    { id: 6, name: "Prof Ephantus Kabiru Wanjohi" },
    { id: 7, name: "Dr Daniel Manguriu" },
    { id: 8, name: "Joel Nderitu" },
    { id: 9, name: "Joseph Pertet" },
